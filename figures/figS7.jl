#=
    ...
    Reproduce Fig. 5 using uninformative prior
=#
...
# Figure 7
figS7 = plot(plts_patient...,layout=grid(4,1),size=(800,700),xlabel="Time [d]",link=:all)
savefig(figS7,"$(@__DIR__)/figS7.svg")
figS7
